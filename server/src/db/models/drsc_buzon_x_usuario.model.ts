...
export class drsc_buzon_x_usuario extends mg_base{
 ...
 fecha_actualizado:{
   ...
   {   sequelize,
     //   indexes: [{unique: true, fields: ['email']}],  
        ...
        modelName: 'drsc_buzon_x_usuario',
        tableName: 'drsc_buzon_x_usuario',
        timestamps: false,
        paranoid: true
   })

   drsc_buzon_x_usuario.sync({force:false, alter:false})
module.exports = drsc_buzon_x_usuario
