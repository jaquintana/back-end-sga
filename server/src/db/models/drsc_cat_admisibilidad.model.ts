...
export class drsc_cat_admisibilidad  extends Model{
      declare id                  : number
       ...
       { 
        hooks:{
         ...
         //   indexes: [{unique: true, fields: ['email']}],  
            ...
            modelName      : 'drsc_cat_admisibilidad',
            tableName      : 'drsc_cat_admisibilidad',
            timestamps     : false,
            paranoid       : true
       })

       drsc_cat_admisibilidad.sync({force:false, alter: false})
      module.exports = drsc_cat_admisibilidad