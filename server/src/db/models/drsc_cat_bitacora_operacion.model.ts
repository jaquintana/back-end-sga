...
export class drsc_cat_bitacora_operacion  extends Model{
      declare id                  : number
   ...
   drsc_cat_bitacora_operacion.init({
    id:{
       ...
       { 
        hooks:{
         ...
         //   indexes: [{unique: true, fields: ['email']}],  
            ...
            modelName      : 'drsc_cat_bitacora_operacion',
            tableName      : 'drsc_cat_bitacora_operacion',
            timestamps     : false,
            paranoid       : true
       })

       drsc_cat_bitacora_operacion.sync({force:false, alter: false})
      module.exports = drsc_cat_bitacora_operacion