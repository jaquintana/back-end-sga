...
export class drsc_cat_criterio_admisibilidad  extends Model{
      declare id                  : number
   ...
   drsc_cat_criterio_admisibilidad.init({
    id:{
       ...
       { 
        hooks:{
         ...
         //   indexes: [{unique: true, fields: ['email']}],  
            ...
            modelName      : 'drsc_cat_criterio_admisibilidad',
            tableName      : 'drsc_cat_criterio_admisibilidad',
            timestamps     : false,
            paranoid       : true
       })

       drsc_cat_criterio_admisibilidad.sync({force:false, alter: false})
      module.exports = drsc_cat_criterio_admisibilidad