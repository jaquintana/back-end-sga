...
export class drsc_cat_estado_actividad  extends Model{
      declare id                  : number
   ...
   drsc_cat_estado_actividad.init({
    id:{
       ...
       { 
        hooks:{
         ...
         //   indexes: [{unique: true, fields: ['email']}],  
            ...
            modelName      : 'drsc_cat_estado_actividad',
            tableName      : 'drsc_cat_estado_actividad',
            timestamps     : false,
            paranoid       : true
       })

       drsc_cat_estado_actividad.sync({force:false, alter: false})
      module.exports = drsc_cat_estado_actividad