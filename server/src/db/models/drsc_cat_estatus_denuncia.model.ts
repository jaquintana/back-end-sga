...
export class drsc_cat_estatus_denuncia  extends Model{
      declare id                  : number
   ...
   drsc_cat_estatus_denuncia.init({
    id:{
       ...
       { 
        hooks:{
         ...
         //   indexes: [{unique: true, fields: ['email']}],  
            ...
            modelName      : 'drsc_cat_estatus_denuncia',
            tableName      : 'drsc_cat_estatus_denuncia',
            timestamps     : false,
            paranoid       : true
       })

       drsc_cat_estatus_denuncia.sync({force:false, alter:false})
      module.exports = drsc_cat_estatus_denuncia