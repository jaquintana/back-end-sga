...
export class drsc_cat_identificada  extends Model{
      declare id                  : number;
      ...
      onUpdate: 'CASCADE'
       ...
       {  sequelize,
         //   indexes: [{unique: true, fields: ['email']}],  
            ...
            modelName: 'drsc_cat_identificada',
            tableName: 'drsc_cat_identificada',
            timestamps: false,
            paranoid: true
       })

       drsc_cat_identificada.sync({force: false, alter: false})
module.exports =drsc_cat_identificada