...
export class drsc_cat_institucion  extends Model{
      declare id                  : number
       ...
       { 
        hooks:{
         ...
         //   indexes: [{unique: true, fields: ['email']}],  
            ...
            modelName      : 'drsc_cat_institucion',
            tableName      : 'drsc_cat_institucion',
            timestamps     : false,
            paranoid       : true
       })

       drsc_cat_institucion.sync({force: false, alter: false})
      module.exports = drsc_cat_institucion