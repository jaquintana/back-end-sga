...
export class drsc_cat_medio_enterado  extends Model{
      declare id                  : number;
      ...
      onUpdate: 'CASCADE'
       ...
       {  sequelize,
         //   indexes: [{unique: true, fields: ['email']}],  
            ...
            modelName: 'drsc_cat_medio_enterado',
            tableName: 'drsc_cat_medio_enterado',
            timestamps: false,
            paranoid: true
       })

       drsc_cat_medio_enterado.sync({force: false, alter: false})
module.exports =drsc_cat_medio_enterado