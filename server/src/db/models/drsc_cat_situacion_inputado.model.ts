...
export class drsc_cat_situacion_inputado  extends Model{
      declare id                  : number;
   ...
   drsc_cat_situacion_inputado.init({
    id: {
      ...
      onUpdate: 'CASCADE'
       ...
       {  sequelize,
         //   indexes: [{unique: true, fields: ['email']}],  
            ...
            modelName: 'drsc_cat_situacion_inputado',
            tableName: 'drsc_cat_situacion_inputado',
            timestamps: false,
            paranoid: true
       })

       drsc_cat_situacion_inputado.sync({force: false, alter: false})
module.exports =drsc_cat_situacion_inputado