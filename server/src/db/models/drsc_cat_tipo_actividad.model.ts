...
export class drsc_cat_tipo_actividad  extends Model{
      declare id                  : number
       ...
       { 
        hooks:{
         ...
         //   indexes: [{unique: true, fields: ['email']}],  
            ...
            modelName      : 'drsc_cat_tipo_actividad',
            tableName      : 'drsc_cat_tipo_actividad',
            timestamps     : false,
            paranoid       : true
       })

       drsc_cat_tipo_actividad.sync({force:false, alter: false})
      module.exports = drsc_cat_tipo_actividad