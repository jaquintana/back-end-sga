...
export class drsc_cat_tipo_denuncia  extends Model{
      declare id                  : number
       ...
       { 
        hooks:{
         ...
         //   indexes: [{unique: true, fields: ['email']}],  
            ...
            modelName      : 'drsc_cat_tipo_denuncia',
            tableName      : 'drsc_cat_tipo_denuncia',
            timestamps     : false,
            paranoid       : true
       })

       drsc_cat_tipo_denuncia.sync({force:false, alter:false})
      module.exports = drsc_cat_tipo_denuncia