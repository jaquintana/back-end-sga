...
export class mat_cat_operador  extends Model{
      declare id                  : number;
      ...
      onUpdate: 'CASCADE'
       ...
       {  sequelize,
         //   indexes: [{unique: true, fields: ['email']}],  
            ...
            modelName: 'mat_cat_operador',
            tableName: 'mat_cat_operador',
            timestamps: false,
            paranoid: true
       })

       mat_cat_operador.sync({force: false, alter: false})
module.exports =mat_cat_operador