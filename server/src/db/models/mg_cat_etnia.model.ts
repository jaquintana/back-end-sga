...
export class mg_cat_etnia  extends Model{
      declare id                  : number;
      ...
      onUpdate: 'CASCADE'
       ...
       {  sequelize,
         //   indexes: [{unique: true, fields: ['email']}],  
            ...
            modelName: 'mg_cat_etnia',
            tableName: 'mg_cat_etnia',
            timestamps: false,
            paranoid: true
       })

       mg_cat_etnia.sync({force: false, alter: false})
module.exports =mg_cat_etnia