...
export class mg_cat_genero  extends Model{
      declare id                  : number;
      ...
      onUpdate: 'CASCADE'
       ...
       {  sequelize,
         //   indexes: [{unique: true, fields: ['email']}],  
            ...
            modelName: 'mg_cat_genero',
            tableName: 'mg_cat_genero',
            timestamps: false,
            paranoid: true
       })

       mg_cat_genero.sync({force:true, alter:true})
module.exports =mg_cat_genero