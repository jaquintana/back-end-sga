...
export class pr_proyecto_admin_grupo extends mg_base{
      declare id:number;
     ...
     eliminado:{
       ...
       {   sequelize,
         //   indexes: [{unique: true, fields: ['email']}],  
            ...
            modelName: 'pr_proyecto_admin_grupo',
            tableName: 'pr_proyecto_admin_grupo',
            timestamps: false,
            paranoid: true
       })

       pr_proyecto_admin_grupo.sync({force:false, alter:false})
module.exports = pr_proyecto_admin_grupo